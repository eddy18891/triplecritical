...
function Cover(){
    return(
        <div id='home' style={{display: 'flex', position:"relative", justifyContent:'left', alignItems:'center', height: 'auto', width: 'auto', paddingTop:"20vh", background:"linear-gradient(to top, hsla(0, 0%, 0%, 1) 0%, hsla(0, 0%, 13%, 1) 100%)"}}>
                ...
                <p style={{position:"absolute", textAlign:"center", top:"70%", left:"70%", overflowWrap:"normal", transform: "translate(-50%, -50%)", color:"white", fontSize:"2.5vw"}}>We do not conform. We smash a new boundary with <b>every</b> game.</p>
